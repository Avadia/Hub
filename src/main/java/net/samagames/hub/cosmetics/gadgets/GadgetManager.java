...
public class GadgetManager extends AbstractCosmeticManager<GadgetCosmetic> {
    ...
    public void useSelectedCosmetic(Player player, ItemStack cosmeticIcon) {
        ...
        net.minecraft.server.v1_12_R1.ItemStack craftStack = CraftItemStack.asNMSCopy(cosmeticIcon);
        NBTTagCompound tagCompound = craftStack.getTag();
        int gadgetKey = Objects.requireNonNull(tagCompound).getInt("gadget-key");
    ...
    public AbstractDisplayer getPlayerGadget(UUID player) {
        return this.playersGadgets.getOrDefault(player, null);
    }

    public int getCooldown(Player player) {
        return this.cooldowns.getOrDefault(player.getUniqueId(), 0);
    }
