...
import net.samagames.hub.commands.admin.CommandAnguille;
import net.samagames.hub.commands.admin.CommandEvacuate;
import net.samagames.hub.commands.admin.CommandPearl;
